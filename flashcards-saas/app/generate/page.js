...
import { Box, Button, Container, Paper, TextField, Typography, Grid2, Card, CardActionArea, CardContent, Dialog, DialogContent, DialogContentText, DialogActions } from "@mui/material"
        ...
        <Container maxWidth="md">
            ...
            {flashcards.length > 0 && (
                <Box sx={{mt: 4}}>
                    ...
                    <Box sx={{mt:4, display:'flex', jsutifyContent:'center'}}>
